...
const printTiedBears = () => {
  let domString = '';
  domString += `<div class="card mb-3" style="max-width: 400px" id="tied-bears">
  <div class="row g-0">
    <div class="col-md-4">
    ...
    <div class="col-md-8">
      <div class="card-body">
        ...
        <p class="card-text">Tied Gold</p>
      </div>
    </div>
  </div>`;
  printToDom('#tie-container', domString);
};

export default printTiedBears;
